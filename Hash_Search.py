...
st.set_page_config(page_title="Malware detection", page_icon=None, layout="centered", initial_sidebar_state="expanded", menu_items=None)
...
while True:
    ...
    get_hash_report(apikey, message)
